      ...
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div className="mt-8 text-center">
          <p className="text-base text-gray-400">
            &copy; 2024 VoiceUp. All rights reserved. Amplifying voices for positive change.
          </p>
          <p className="mt-2 text-sm text-gray-400">
            Built with ❤️ for activists, advocates, and changemakers worldwide.
          </p>
        </div>
        ...
        <div className="mt-6 flex justify-center space-x-6 text-sm text-gray-400">
          ...
          <Link to="/help" className="hover:text-gray-500">Help Center</Link>
        </div>
      </div>
    </footer>
  );
